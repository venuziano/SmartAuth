...
async function createWallet (pwd) {
  await web3.eth.personal.newAccount(pwd, function(err, account){
    if(!err){
...
async function unlockAccount(account, pwd){
    await web3.eth.personal.unlockAccount(account, pwd, 600)
